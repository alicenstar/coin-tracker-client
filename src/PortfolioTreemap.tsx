...
import { currencyFormatter, largeCurrencyFormatter } from './utils/Formatters';
...
export const PortfolioTreemap: React.FC<IProps> = ({
    data,
    height,
    width
}: IProps) => {
            ...
            .on("mouseover", function(d) {
                tooltip.html(`
                    <div>
                        ...
                        <p>Value: ${currencyFormatter.format(d.target.__data__.value)}</p>
                    </div>
                `);
    ...
    return (
        <svg style={{ height: height, width: width }} ref={svgRef} />
    );
};